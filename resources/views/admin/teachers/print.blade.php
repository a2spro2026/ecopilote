...
<head>
    <meta charset="utf-8">
    <title>Fiche {{ $professeur->displayId() }} · ECOPILOTE</title>
    <style>
...
<body>
    <div class="header"><div><div class="logo">ECOPILOTE</div><div>Fiche professeur</div></div><div class="id">{{ $professeur->displayId() }}</div></div>
    <div class="profile">
