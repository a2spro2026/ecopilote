    ...
    <section class="rounded-2xl border border-slate-200/80 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
        ...
        <div class="grid gap-3 sm:grid-cols-2">
            ...
            <div>
                ...
                <p class="mt-1 text-[11px] text-slate-500">Le login est généré automatiquement à partir du nom (ex. nadia.el.amrani{{ \App\Support\EcopiloteIdentity::emailSuffix() }}).</p>
            </div>
            <div>
