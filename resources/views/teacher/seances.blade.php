                ...
                <tr>
                    ...
                    <td>
                        <div class="flex justify-center gap-2">
                            ...
                            @if (in_array($s['statut'], ['a_venir', 'en_direct'], true))
                                <a href="{{ route('teacher.salle') }}" class="text-xs font-semibold text-emerald-600">Entrer</a>
                            @endif
...
<div class="grid gap-3 md:hidden">
    @foreach ($seances as $s)
        ...
        <article class="rounded-2xl border border-slate-200 bg-white p-4">
            ...
            <p class="text-sm text-slate-500">{{ $s['eleves'] }} élèves · {{ $s['professeur'] }}</p>
        </article>
    @endforeach
</div>
@endsection
